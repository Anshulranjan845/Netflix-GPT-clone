...
const VideoTitle = ({title,overview}) => {
  ...
  return (
    <div className='flex flex-col px-8 py-[250px] w-1/2 font-sans absolute w-screen aspect-video bg-gradient-to-r from-black'>
      <h1 className='font-bold text-6xl mb-4 text-white'>{title}</h1>
      <p className='font-semibold text-sm text-gray-300'>{overview}</p>
